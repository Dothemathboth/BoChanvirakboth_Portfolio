...
const projectsData = {
    'linkVilla': {
        ...
        programs: [
            { alt: "Revit", src: "https://placehold.co/40x40/E8615A/FFFFFF?text=R" },
            { alt: "AutoCAD", src: "https://placehold.co/40x40/3E84F4/FFFFFF?text=A" },
            { alt: "RSA", src: "https://placehold.co/40x40/D15B5B/FFFFFF?text=R" },
            { alt: "Prokon", src: "https://placehold.co/40x40/3DB54A/FFFFFF?text=P" },
            { alt: "Midas", src: "https://placehold.co/40x40/C0C0C0/FFFFFF?text=M" }
        ],
...
function showProjectModal(projectKey) {
    ...
    const modalBodyHTML = `
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mt-8 gap-6">
            ...
            <!-- View More Button -->
            <button class="${project.viewMoreBtnBg} text-white py-3 px-8 rounded-lg shadow-md transition-colors">
                View More Resources
            </button>
        </div>
    `;
...
$(document).ready(function () {
    ...
    const skillsData = [
        { name: "Revit", icon: "Picture/Skills/autodesk-revit.png", proficiency: 80, creativity: 90,
          description: "Expert proficiency in Autodesk Revit for BIM modeling, focusing on structural design, documentation, and coordination. Experienced in creating complex structural models, families, and drawing sheets compliant with international standards.",
          projects: ["High-rise Residential Tower Structural Model", "Commercial Office Building BIM Coordination", "Custom Revit Family Development"]
        },
        { name: "AutoCAD", icon: "Picture/Skills/autodesk-autocad.png", proficiency: 80, creativity: 90,
          description: "Highly skilled in 2D and 3D drafting and detailing using AutoCAD. Proficient in producing construction drawings, structural plans, and section details accurately and efficiently for QA/QC submission.",
          projects: ["Foundation Detailing for Industrial Plant", "As-Built Drawing Documentation", "Steel Structure Connection Detailing"]
        },
        ...
        { name: "RSA", icon: "Picture/Skills/autodesk-rsa.png", proficiency: 80, creativity: 70,
          ...
          projects: ["Seismic Analysis of Concrete Frame Structure", "Steel Truss Optimization Study"]
        },
        { name: "Inventor", icon: "Picture/Skills/inventor.png", proficiency: 30, creativity: 70,
        ...
        { name: "Dynamo", icon: "Picture/Skills/dynamo.png", proficiency: 40, creativity: 40,
          description: "Advanced skills in visual programming with Dynamo for automating repetitive BIM tasks, generating complex geometry, and integrating data flows between Revit and Excel, significantly boosting workflow efficiency.",
        ...
        { name: "ETAB", icon: "Picture/Skills/ETAB.png", proficiency: 80, creativity: 70,
          ...
          projects: ["Mid-rise Building Analysis and Design", "Shear Wall System Optimization"]
        },
        { name: "Mathcad Prime", icon: "Picture/Skills/mathcad-prime.png", proficiency: 80, creativity: 80,
          ...
          projects: ["Slab Load Calculation Sheets", "Beam Design Check Calculations"]
        },
        { name: "Mathcad15", icon: "Picture/Skills/mathcad15.png", proficiency: 50, creativity: 80,
          description: "Used legacy Mathcad 15 for complex mathematical modeling and solving engineering problems efficiently before transitioning to Prime.",
          projects: ["Retaining Wall Design Calculation (Legacy)", "Wind Load Analysis"]
        },
        ...
        { name: "MS Excel", icon: "Picture/Skills/microsoftexcel.png", proficiency: 90, creativity: 100,
          description: "Advanced skills in data analysis, custom formula creation, and template development for engineering design checks, material tracking, and cost estimations.",
